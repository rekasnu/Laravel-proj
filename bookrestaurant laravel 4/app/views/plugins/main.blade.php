	...
	-->
		...
		<div class="t2">
			<div class="span4 offset4">
				...
				{{ Form::open(array('url' => 'search_results', 'method' => 'GET', 'onsubmit'=>'check()')) }}
...
//	var location_city = geoplugin_city();
//	var location_country =  geoplugin_countryName();
//
//	function check(){
//		var loc = document.getElementById('location').value;
//		if(loc === ''){
//			document.getElementById('location').value = location_city;
//		}
//	}
 </script>
