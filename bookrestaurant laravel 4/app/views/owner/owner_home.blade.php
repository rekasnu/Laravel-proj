...
@section('content')
	...
	<div class="row">
		<div class="col-md-3 col-md-offset-2 pp">
			{{ HTML::link('create_rest_profile','Create restaurant profile', array('type'=>'button','class'=>'btn btn-primary btn-lg vv xl'))}}
		</div>
	...
	<div class="row">
		...
		<div class="col-md-3 col-md-offset-1 pp">
			{{ HTML::link('owner_home#','Manage restaurants', array('type'=>'button','class'=>'btn btn-warning btn-lg vv xl'))}}
		</div>
	</div>
@endsection