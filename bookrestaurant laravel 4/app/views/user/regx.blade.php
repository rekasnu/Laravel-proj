...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		{{ Form::open(array('url' => 'register2', 'method' => 'POST')) }}
			<h2>Please Sign Up <small class="reg-text">It's free and always will be.</small></h2>
			<hr class="colorgraph">
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
                        {{ Form::text('f_name', '', array('id'=>'first_name','class'=>'form-control input-lg', 'placeholder'=>'First Name', 'tabindex'=>'1')) }}
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
						{{ Form::text('l_name', '', array('id'=>'last_name','class'=>'form-control input-lg', 'placeholder'=>'Last Name', 'tabindex'=>'2')) }}
					</div>
				</div>
			</div>
			<div class="row">
				<div class=" col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
						{{ Form::text('d_name', '', array('id'=>'display_name','class'=>'form-control input-lg', 'placeholder'=>'Login Name', 'tabindex'=>'3')) }}
					</div>
				</div>
			</div>
			<div class="row">
		...
		<!--				{{ Form::checkbox('t_and_c', '', array('id'=>'t_and_c', 'type'=>'hidden', 'class'=>'hidden'))}}  -->
					</span>
				</div>
